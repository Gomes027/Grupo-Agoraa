...
class ClipboardManager:
    @staticmethod
    def aguardar_conteudo_area_transferencia(atalho, tempo_espera=80, tentativas=3):
        while tentativas > 0:
...
class ImageProcessor:
    ...
    def processar_imagens(pasta):
        ...
        WindowManager.procurar_botao_e_clicar(r"teste.png", semelhança=0.9)
...
class AutomationManager:
    ...
    def processar_arquivo(self, arquivo_completo):
        ...
        self.window_manager.procurar_botao_e_clicar(r"atualizar.png")
        self.window_manager.procurar_botao_e_clicar(r"continuar.png"); sleep(15)
