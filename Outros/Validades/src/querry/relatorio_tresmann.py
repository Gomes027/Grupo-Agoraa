...
def verificar_e_atualizar_csv_tresmann():
    ...
    caminho_csv = r"F:\COMPRAS\Automações.Compras\Automações\Outros\Validades\tables\relatorio_tresmann_filtrado.csv"
    ...
    colunas = [
        "CODIGO", "NOME", "LOJA", "ESTOQUE ATUAL", 
        "VCTO_MEDIO", "VENDA MEDIA"
    ]
