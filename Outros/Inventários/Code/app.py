...
frame_a = ctk.CTkFrame(master=app, corner_radius=10, width=140)
...
frame_c = ctk.CTkFrame(master=app, corner_radius=10, width=140)
frame_c.grid(row=0, column=3, rowspan=3, sticky="nsew", padx=(10, 20), pady=20)

# Label with text "Códigos:" inside frame_a
label_codes = ctk.CTkLabel(master=frame_a, text="Códigos:", anchor="w")  # Adjust font as needed
label_codes.pack(fill='x', padx=20, pady=(10, 0))

# Textbox for multi-line text input inside frame_a
textbox_codes = ctk.CTkTextbox(master=frame_a)
