...
from Email.config import CAMINHO_ARQUIVO_ESTOQUES, CAMINHO_ARQUIVO_DESCONTOS, CAMINHO_ARQUIVO_ENCARTES, CAMINHO_ARQUIVO_LOJAS, CAMINHO_ARQUIVO_VINHOS, CAMINHO_ARQUIVO_FATURAMENTO, CAMINHO_ARQUIVO_VOLUME, EMAIL_REMETENTE, EMAIL_SENHA, EMAIL_DESTINATARIOS
...
def enviar_email():
    ...
    faturamento = excel_to_html(CAMINHO_ARQUIVO_FATURAMENTO, "Faturamento", [], ["DESCRIÇÃO", "SMJ", "STT", "VIX", "MCP", "TOTAL"], aplicar_total=True)
    ...
    titulo_faturamento = '<h2 style="font-weight:bold;">FATURAMENTO</h2>'
    ...
    corpo_email = (
        ...
        titulo_faturamento + faturamento + '<br><br><br>' +
